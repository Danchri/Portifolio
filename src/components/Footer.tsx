const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/danielsdg',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/danielsdg',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:daniel.sdg@protonmail.com',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-gray-400">
                <span className="text-green-400">🔐</span> daniel.sdg@protonmail.com
              </p>
              <p className="text-gray-400">
                <span className="text-green-400">🌍</span> Global Security Consulting
              </p>
              <p className="text-gray-400">
                <span className="text-green-400">🛡️</span> Cybersecurity Expert
              </p>
            </div>
          </div>
        </div>
